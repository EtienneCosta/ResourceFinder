...
--- (c) Depicting trees using DOT / Graphviz -----------------------------------

dotBTree :: Show a => BTree a -> IO ExitCode
dotBTree = dotpict . bmap (const Nothing) (Just . show) . cBTree2Exp

dotLTree :: Show a => LTree a -> IO ExitCode
dotLTree = dotpict . bmap (Just . show) Just . cLTree2Exp
